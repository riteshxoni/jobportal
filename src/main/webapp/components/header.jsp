  ...
  <body>
      <header class="position-fixed bg-white w-100">
        <!-- Top Header & Logo Section -->
          <div class="row bg-yg px-3 py-3 pt-4 text-center justify-content-between ">
              <div class="col-12 col-sm-5 mb-2 d-flex align-items-center justify-content-center">
                  <img src="${pageContext.request.contextPath}/images/CareerConnectLogo.png" alt="CareerConnectLogo" height="30px">
                  <span class="fw-bold text-white fs-5 px-2">Job Portal</span>
              </div>
              <div class="col-sm-5 text-white">
                  <a href="${pageContext.request.contextPath}/view/login.jsp" class="text-decoration-none mx-2 text-white fw-bold btn shadow-lg animate ">Login</a> /
                  <a href="${pageContext.request.contextPath}/view/register.jsp" class="text-decoration-none mx-2 text-white fw-bold btn shadow-lg animate ">Register</a>
              </div>
          </div>
